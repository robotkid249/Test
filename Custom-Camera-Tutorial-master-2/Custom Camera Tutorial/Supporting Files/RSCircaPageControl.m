...
#define SCRUBBLE_CURRENT_BG_IMAGE    [UIImage imageNamed:@""]
#define SCRUBBLE_CURRENT_BLACK_IMAGE [UIImage imageNamed:@""]
#define SCRUBBLE_CURRENT_DOT_IMAGE   [UIImage imageNamed:@""]
#define SCRUBBLE_DOT_IMAGE           [UIImage imageNamed:@""]
